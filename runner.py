...
def continue_running(time, i_file, o_file, c, b, q, e, l, n, di, dq, yi, ya, yh, a, t):
    ...
    run(o_file, c, b, q, e, l, n, di, dq, yi, ya, yh, a, t, *(line_nums[1:]), offset_time = line_nums[0])
...
def run(o_file, c, b, q, e, l, n, di, dq, yi, ya, yh, a, t, S, E, I, A, Sq, Eq, H, R, D, *, offset_time = 0.0):
...
def main():
    ...
    set_t            = [1]               # how infective is A compaired to I
    set_S            = [11081000]        #
    set_E            = [105.1]           #
    set_I            = [27.679]          #
    set_A            = [53.839]          #
    ...
    sets = (set_c, set_b, set_q, set_e, set_l, set_n, set_di, set_dq, set_yi, set_ya, set_yh, set_a, set_t, set_S, set_E, set_I, set_A, set_Sq, set_Eq, set_H, set_R, set_D)
...
def c_main(i_file_name, offset_time):
    ...
    sets = (set_c, set_b, set_q, set_e, set_l, set_n, set_di, set_dq, set_yi, set_ya, set_yh, set_a, set_t)
