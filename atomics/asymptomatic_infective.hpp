...
#ifndef _ASYMPTOMATIC_INFECTIVE_HPP__
#define _ASYMPTOMATIC_INFECTIVE_HPP__
...
using namespace std;
    ...
    class asymptomatic_infective{
        public:
            ...
            // default constructor
            asymptomatic_infective() noexcept{
              assert(false && "default constructor is not available");
            }
            asymptomatic_infective(double initial_population){
            ...
            void external_transition(TIME e, typename make_message_bags<input_ports>::type mbs) {
                ...
                // A'  = (e*(1-n)*E)-(ya*A)
                state.population_delta = ((e*(1-n)*state.exposed)-(ya*state.population))*dt;
                state.report_queued = true;
            }
            ...
            friend std::ostringstream& operator<<(std::ostringstream& os, const typename asymptomatic_infective<TIME>::state_type& i) {
                 os.precision(2);
                os << fixed;
                os << "{\"asymptomatic_infective\":" << i.population+i.population_delta << "}";
            return os;
            }
        };


#endif // _ASYMPTOMATIC_INFECTIVE_HPP__
