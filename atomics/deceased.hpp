...
#ifndef _DECEASED_HPP__
#define _DECEASED_HPP__
...
using namespace std;
    ...
    class deceased{
        public:
            ...
            deceased(double initial_population){
            ...
            void external_transition(TIME e, typename make_message_bags<input_ports>::type mbs) {
                ...
                // D'  = ((a*I)+(a*H))
                state.population_delta = ((a*state.symptomatic_infective)+(a*state.quarantined_infective))*dt;
                state.report_queued = true;
            }
            ...
            friend std::ostringstream& operator<<(std::ostringstream& os, const typename deceased<TIME>::state_type& i) {
                 os.precision(2);
                os << fixed;
                os << "{\"deceased\":" << i.population+i.population_delta << "}";
            return os;
            }
        };


#endif // _DECEASED_HPP__
